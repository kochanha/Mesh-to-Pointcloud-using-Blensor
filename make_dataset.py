...
def make_dataset(dataset_name: str, blensor_bin: str, base_dir: str, num_processes=7,
    ...
    normalize_meshes(base_dir=base_dir, in_dir='01_base_meshes_ply', out_dir='03_meshes', dataset_dir=dataset_dir,
...
if __name__ == "__main__":
	...
	'cube', 'armadillo', 'bunny', 'homer'
        
    ]

    for d in datasets:
        print("Converting "+ d +" to PC")
